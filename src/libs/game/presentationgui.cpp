...
void PresentationGUI::renderOffscreen() {
    if (_gui) {
        _gui->renderOffscreen();
    }
}

bool PresentationGUI::hostsScene() const {
...
void PresentationGUI::useBakedItemSlotArt(ListBox &listBox) {
    ...
    listBox.setBackgroundRenderer(
        [panel, canvas, iconInk, nameplateInk](const ListBox &list, const glm::ivec2 &offset, I2DRenderer &renderer2d) {
