...
constexpr const char *kModules[] = {
    ...
    "debug_view", "debug_overlay", "retro_guides"};
...
#define REONE_STORAGE_LAYOUT slang::LayoutRules::DefaultStructuredBuffer
    check(layout, "InstanceMaterial", sizeof(InstanceMaterial),
          ...
          {REONE_SCHEMA_FIELD(InstanceMaterial, selfIllumColor),
           ...
           REONE_SCHEMA_FIELD(InstanceMaterial, overrideMetallic),
           ...
           REONE_SCHEMA_FIELD(InstanceMaterial, overrideF0),
...
#define REONE_UNIFORM_FIELD(type, field) \
    ...
    checkUniform("ScreenEffectUniforms", sizeof(ScreenEffectUniforms),
                 {REONE_UNIFORM_FIELD(ScreenEffectUniforms, projection),
                  ...
                  REONE_UNIFORM_FIELD(ScreenEffectUniforms, ssaoStrength),
                  REONE_UNIFORM_FIELD(ScreenEffectUniforms, ssaoSampleCount),
                  ...
                  REONE_UNIFORM_FIELD(ScreenEffectUniforms, ssrMaxDistance),
                  REONE_UNIFORM_FIELD(ScreenEffectUniforms, ssrEdgeFadeStart),
                  REONE_UNIFORM_FIELD(ScreenEffectUniforms, ssrRoughness),
                  REONE_UNIFORM_FIELD(ScreenEffectUniforms, ssrAnimatedNoise),
