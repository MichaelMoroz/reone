...
justified them, the measurements not to re-derive. That one is what to do next.

| you want | go to |
|---|---|
| the step to do next | [`phase-f.md`](phase-f.md) |
| why a phase exists at all | the reasoning sections below |
| a measurement marked *do not re-derive* | the phase it was taken in |
